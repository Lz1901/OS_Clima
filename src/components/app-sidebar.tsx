...
const nav = [
  ...
  { to: "/unidades", label: "Unidades", icon: Building2, permission: "unidades.view" },
  { to: "/equipamentos", label: "Equipamentos", icon: Wrench, permission: "equipamentos.view" },
  { to: "/financeiro", label: "Financeiro", icon: DollarSign, permission: "financeiro.view" },
  { to: "/checklists", label: "Checklists", icon: ListChecks, permission: "configuracoes.view" },
  { to: "/logs", label: "Atividade", icon: Activity, permission: "auditoria.view" },
  { to: "/notificacoes", label: "Notificações", icon: Bell },
  { to: "/funcionarios", label: "Funcionários", icon: UserCog, permission: "funcionarios.view" },
  { to: "/configuracoes", label: "Configurações", icon: Settings, permission: "configuracoes.view" },
